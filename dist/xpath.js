...
function nodeOrder(n1, n2) {
    ...
    let n1Par = n1.parentNode || n1.ownerElement, n2Par = n2.parentNode || n2.ownerElement;
    // find common parent
    while (n1Par !== n2Par) {
        n1 = n1Par;
        n2 = n2Par;
    ...
    if (n1Par) {
        const cn = n1isAttr ? n1Par.attributes : n1Par.childNodes, len = cn.length;
...
function lang() {
    ...
    let lang;
    for (let n = c.contextNode; n != null && n.nodeType != 9 /*Node.DOCUMENT_NODE*/; n = n.parentNode) {
...
// functional helpers
function curry(func) {
    const { slice } = Array.prototype, totalargs = func.length, partial = function (args, fn) {
        return function () {
