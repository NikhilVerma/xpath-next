...
class XPathNamespace {
	static XPATH_NAMESPACE_NODE: any;
...
class NodeTest {
	...
	static makeNodeTestType(type, members, ctor?: any) {
...
var XPathException = (function () {
	class XPathException extends Error {
		...
		constructor(code: number, error?: any, message?: any) {
			super(String(code));
		...
		static fromMessage(message, error?: any) {
...
function assign(target, varArgs, ...args: any[]) {
